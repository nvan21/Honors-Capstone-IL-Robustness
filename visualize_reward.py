...
def run(args):
    ...
    disc_file = "./logs/InvertedPendulum-v5/airl/normal_env-seed0-20250402-1958/model/step350000/disc.pth"
    disc = AIRLDiscrim(
    ...
    states = torch.randn((4)).clamp(-0.2, 0.2)
    ...
    print(f"Starting state: {states} {states.shape}")
